...
#[derive(Clone)]
pub struct InstructionParser<'a>(BoxedParser<'a, Token, Vec<Spanned<Argument>>, Simple<Token>>);
...
impl<'a> std::fmt::Debug for InstructionParser<'a> {
